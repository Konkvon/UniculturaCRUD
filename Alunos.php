<?php
     ...
     /* criarmos uma classe para ter acesso ao BD e criarmos dois métodos  de consulta:
      ...
      /* Criamos uma class chamar "Alunos"  */
      class Alunos 
      {
        ...
        public static function select(int $id)
        {
            ...
            $tabela = "aluno"; //variável para nome da tabela
            $coluna = "id"; //variável para chave primaria            
        ...
        public static function insert($dados)
        {
            ...
            $sql = "insert into $tabela (nome,endereco,telefone,codigo_turma,curso) values (:nome, :endereco, :telefone, :codigo_turma, :curso)";
            $stmt = $connPdo->prepare($sql); 
            //Mapeamento de parâmetros com campos da tabela             
            $stmt->bindValue(':nome' , $dados['nome']) ;
            $stmt->bindValue(':endereco' , $dados['endereco']) ;
            $stmt->bindValue(':telefone' , $dados['telefone']) ;
            $stmt->bindValue(':codigo_turma' , $dados['codigo_turma']) ;
        ...
        public static function alterar($id,$dados)
        {
            ...
            $sql = "update $tabela set nome=:nome,endereco=:endereco,telefone=:telefone, codigo_turma=:codigo_turma, curso=:curso where $coluna=:id";
            $stmt = $connPdo->prepare($sql); 
            //Mapeamento de parâmetros com campos da tabela
            $stmt->bindValue(':id' , $id) ; 
            $stmt->bindValue(':nome' , $dados['nome']) ;
